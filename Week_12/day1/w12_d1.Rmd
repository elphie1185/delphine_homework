...
groupwiseMean(Lot.Area ~ House.Style, 
              ...
              conf = 0.99)
```
# Some of the groups have very few observations 2.5Fin for example but the CI does adjust for it
...
# wald method = normal distribution
# wilson pretends that the binomial distribution is continuous
...
# if the proportion are too uneven use wilson else use wald
